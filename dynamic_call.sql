 ...
 void SendMessage()
{
  ...
  SIM900A.println("AT+CMGS=\"+8801687602005\"\r"); //Mobile phone number to send message
  delay(1000);
  Serial.println ("Set SMS Content");
  SIM900A.println(a);// Messsage content
  delay(100);
 ...
 void RecieveMessage()
{
 ...
 void RecieveMessage1(String b)
{
  
  delay (1000);
  b.trim();
  Serial.println (b);
  SIM900A.println("ATD"+b+";");
